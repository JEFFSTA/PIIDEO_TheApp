...
import ru.crew.motley.piideo.piideo.AutoFitTextureView;
...
public class PhotoFragment extends Fragment
    ...
    private TextView mSnapTextView;
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            mFile = new File(piideoFolder, mPiideoName + ".jpg");
...
//        view.findViewById(R.id.info).setOnClickListener(this);
        ...
        mSnapTextView = view.findViewById(R.id.button_text);
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.picture: {
                ...
                mSnapTextView.setTextColor(colorId);
                takePicture();
                break;
            }
        }
...
//
            Intent i = PiideoActivity.getIntent(getContext(), mPiideoName, mMessage, mMessageId);
            startActivity(i);
            getActivity().finish();
        } catch (Exception e) {
            e.printStackTrace();
